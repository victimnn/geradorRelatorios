# README: Gerador de Relatório Financeiro usando LangChain e Streamlit
...
2. **Instalar as Dependências:**  
   ```bash
   pip install streamlit langchain langchain_google_genai pyyaml
   ```

3. **Configurar a API do Google:**  
   - No diretório do projeto, crie um arquivo chamado `config.yaml` e insira sua chave de API do Google.
